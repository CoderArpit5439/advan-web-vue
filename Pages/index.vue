<template>
	<div class="site lg-mt-5 lg-mb-0 mb-0 mt-0">
		<div class="site__body">
			...
			<div class="block-finder block">
				...
				<div class="block-finder__image"
					...
					<div class="keen-slider">
						...
						}" class="block-slideshow__item keen-slider__slide">
						</div>
					</div>
			...
			<HomePageOneExtraFeaturedProducts />
			<!-- EXTRA PRODUCT ONE END -->


			<div class="block-space block-space--layout--divider-lg"></div>
			<!-- EXTRA PRODUCT TWO START -->
			<HomePageTwoExtraFeaturedProducts />
			<!-- EXTRA PRODUCT TWO END -->


			<div class="block-space block-space--layout--divider-lg"></div>
			<!-- EXTRA PRODUCT THREE START -->
			<HomePageThreeExtraFeaturedProducts />
			<!-- EXTRA PRODUCT THREE START -->


			<div class="block-space block-space--layout--divider-nl"></div>
			<!-- CATEGORY BENNER CARD START -->
			<div class="block-banners block my-4">
				<div class="container">
					<div class="block-banners__list">
						<a href="#" class="block-banners__item block-banners__item--style--one">
							...
							<span class="block-banners__item-details">Synthetic motor oil with free shipping<br>Friction
								free life guaranteed </span>
						</a>
						<a href="#" class="block-banners__item block-banners__item--style--two"><span
								class="block-banners__item-image">
							...
							<span class="block-banners__item-details">Luxurious interior part for real
								aesthetes<br>Leather, fabric, ivory and more. </span>
						</a>
					</div>
				</div>
			</div>
...
.card:hover .gray-image {
	filter: grayscale(0%);
}

/* Hover effect to restore normal color */
