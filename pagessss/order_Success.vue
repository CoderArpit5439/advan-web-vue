						...
						<div class="card order-success__meta">
							<ul class="order-success__meta-list">
								...
								<li class="order-success__meta-item"><span
										...
										class="order-success__meta-value">1334.00</span></li>
								...
								<table>
											...
											<td class="order-list__column-image">
												<div class="image image--type--product"><a href="#"
														class="image__body"><img class="image__tag"
															src="https://images.unsplash.com/photo-1729830114379-4c3dfe391a74?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt=""></a></div>
											</td>
											<td class="order-list__column-product"><a href="#">Left
									...
									<tfoot class="order-list__footer">
										<tr>
											...
											<td class="order-list__column-total">1334.00</td>
										</tr>
									</tfoot>
								</table>
							</div>
