              ...
              <div class="col-12 col-xl-4">
                <div class="site-footer__widget footer-contacts">
                  ...
                  <address class="footer-contacts__contacts">
                    ...
                    <dl>
                      <dt>Our Location</dt>
                      <dd>N.H. 47 Choudhary Market Tejaji Nagar Khandwa Road Indore (M.P)</dd>
                    </dl>
                    <dl>
                      <dt>Working Hours</dt>
                ...
                <div class="site-footer__widget footer-links">
                  ...
                  <ul class="footer-links__list">
                    <li class="footer-links__item"><a href="#" class="footer-links__link">Store
                        Location</a></li>
                    <li class="footer-links__item"><a href="/dashboard/order" class="footer-links__link">Order
                        History</a></li>
